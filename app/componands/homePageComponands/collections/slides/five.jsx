            ...
            <div className="w-[30%] h-full">
                <Link href={'/collections/shirts'} >
                    <div className=" relative h-[70%] w-full">
                        ...
                        <div className="size-full absolute top-0 left-0 bg-black/50 text-white flex justify-center items-center">
                            <h1 className="font-mono font-bold text-[100px]">SHIRTS</h1> 
                        </div>
                    </div>
                </Link>
                <div className=" w-full h-[20%] pt-5">
                    ...
                    <div className="w-full flex justify-between items-center">
                        <ul className=" text-[10px] flex items-center gap-3 font-mono font-bold"> 
                            <li>Formal</li> 
                            <span className='w-[10px] h-[1px] bg-black'></span>
                            <li>Casual</li> 
                        </ul>
                        <Link className="justify-start py-5 flex gap-2 text-[10px] font-mono font-bold items-center" href={'/collections/shirts'}>
