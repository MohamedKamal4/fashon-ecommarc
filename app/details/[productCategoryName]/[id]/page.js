...
export default function ProductDetails(){
    const {id , productCategoryName} = useParams()
                                        ...
                                        <div className="w-full flex flex-col gap-10 px-20">
                                            <div className="py-5 border-b-[1px] border-black flex flex-col gap-3">
                                                <div className=" w-full flex justify-between items-center">
                                                    ...
                                                    <div>
                                                        <button className=" cursor-pointer"><CiBookmark size={15} /></button>
                                                    </div>
                                                </div>
                                            ...
                                            <div className=" flex w-full items-end gap-5">
                                                <button className=" text-[10px] cursor-pointer w-[100%] py-2 bg-black text-white">ADD</button>
                                            </div>
